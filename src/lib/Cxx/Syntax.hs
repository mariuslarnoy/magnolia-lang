...
module Cxx.Syntax (
  CxxAccessSpec (..),
  CxxDef (..), CxxExpr (..), CxxFunctionDef (..), CxxLambdaCaptureDefault (..),
  CxxModule (..), CxxModuleRefSpecialization (..),
  CxxName, CxxNamespaceName, CxxStmt (..), CxxStmtBlock,
  CxxStmtInline (..), CxxType (..), CxxVar (..),
  mkCxxName, mkCxxType) where
