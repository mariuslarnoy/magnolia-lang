...
public:
    ...
    private:
        ...
        PDEProgram3D::_unary_sub unary_sub;
    public:
        __host__ __device__ inline PDEProgram3D::Float operator()(const PDEProgram3D::Array& u, const PDEProgram3D::Array& v, const PDEProgram3D::Array& u0, const PDEProgram3D::Array& u1, const PDEProgram3D::Array& u2, const PDEProgram3D::ScalarIndex& i, const PDEProgram3D::ScalarIndex& j, const PDEProgram3D::ScalarIndex& k) {
