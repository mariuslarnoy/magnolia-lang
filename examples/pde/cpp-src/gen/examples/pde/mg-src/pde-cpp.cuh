...
struct PDEProgram {
    ...
    __host__ __device__ static PDEProgram::_two two;
    struct _one {
        template <typename T>
        inline __host__ __device__ T operator()() {
            T o;
    ...
    __host__ __device__ static PDEProgram::_one one;
private:
    __host__ __device__ static array_ops __array_ops;
public:
...
public:
    ...
    __host__ __device__ static PDEProgram::_three three;
    struct _unary_sub {
    ...
    __host__ __device__ static PDEProgram::_unary_sub unary_sub;
private:
...
public:
    ...
    __host__ __device__ static PDEProgram::_rotate_ix rotate_ix;
    struct _zero {
    ...
    __host__ __device__ static PDEProgram::_zero zero;
private:
...
public:
    ...
    __host__ __device__ static PDEProgram::_binary_add binary_add;
    struct _binary_sub {
        inline __host__ __device__ PDEProgram::Float operator()(const PDEProgram::Float& lhs, const PDEProgram::Float& rhs) {
    ...
    __host__ __device__ static PDEProgram::_binary_sub binary_sub;
    struct _div {
    ...
    __host__ __device__ static PDEProgram::_div div;
    ...
    __host__ __device__ static PDEProgram::_forall_ix_snippet forall_ix_snippet;
    ...
    __host__ __device__ static PDEProgram::_forall_ix_snippet_cuda forall_ix_snippet_cuda;
    struct _mul {
        inline __host__ __device__ PDEProgram::Float operator()(const PDEProgram::Float& lhs, const PDEProgram::Float& rhs) {
   ...
   __host__ __device__ static PDEProgram::_mul mul;
    struct _psi {
    ...
    __host__ __device__ static PDEProgram::_psi psi;
    struct _rotate {
    ...
    __host__ __device__ static PDEProgram::_rotate rotate;
    struct _snippet {
        inline __host__ __device__ void operator()(PDEProgram::Array& u, const PDEProgram::Array& v, const PDEProgram::Array& u0, const PDEProgram::Array& u1, const PDEProgram::Array& u2, const PDEProgram::Float& c0, const PDEProgram::Float& c1, const PDEProgram::Float& c2, const PDEProgram::Float& c3, const PDEProgram::Float& c4) {
            u = PDEProgram::forall_ix_snippet(u, v, u0, u1, u2, c0, c1, c2, c3, c4);
        };
    };

    __host__ __device__ static PDEProgram::_snippet snippet;
    struct _snippet_ix {
...
private:
    __host__ __device__ static forall_ops<PDEProgram::Array, PDEProgram::Axis, PDEProgram::Float, PDEProgram::Index, PDEProgram::Nat, PDEProgram::Offset, PDEProgram::_snippet_ix> __forall_ops;
public:
    __host__ __device__ static PDEProgram::_snippet_ix snippet_ix;
    struct _step {
