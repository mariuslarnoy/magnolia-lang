...
struct PDEProgram {
    struct _two {
        template <typename T>
        inline __host__ __device__T operator()() {
            T o;
            PDEProgram::two0(o);
            return o;
        };
...
private:
    static inline __host__ __device__void one0(PDEProgram::Offset& o) {
...
public:
    ...
    struct _three {
        inline __host__ __device__PDEProgram::Float operator()() {
    ...
    struct _unary_sub {
        inline __host__ __device__PDEProgram::Float operator()(const PDEProgram::Float& f) {
            return __array_ops.unary_sub(f);
        };
        inline __host__ __device__PDEProgram::Offset operator()(const PDEProgram::Offset& o) {
...
private:
    static inline __host__ __device__void one0(PDEProgram::Float& o) {
        o = __array_ops.one_float();
    };
    static inline __host__ __device__void two0(PDEProgram::Float& o) {
        o = __array_ops.two_float();
    };
public:
    typedef array_ops::Axis Axis;
    struct _rotate_ix {
        inline __host__ __device__PDEProgram::Index operator()(const PDEProgram::Index& ix, const PDEProgram::Axis& axis, const PDEProgram::Offset& o) {
    ...
    struct _zero {
        inline __host__ __device__PDEProgram::Axis operator()() {
...
private:
    static inline __host__ __device__void one0(PDEProgram::Axis& o) {
        o = __array_ops.one_axis();
    };
    static inline __host__ __device__void two0(PDEProgram::Axis& o) {
        o = __array_ops.two_axis();
    };
public:
    typedef array_ops::Array Array;
    struct _binary_add {
        inline __host__ __device__PDEProgram::Float operator()(const PDEProgram::Float& lhs, const PDEProgram::Float& rhs) {
            return __array_ops.binary_add(lhs, rhs);
        };
        inline __host__ __device__PDEProgram::Array operator()(const PDEProgram::Float& lhs, const PDEProgram::Array& rhs) {
            return __array_ops.binary_add(lhs, rhs);
        };
        inline __host__ __device__PDEProgram::Array operator()(const PDEProgram::Array& lhs, const PDEProgram::Array& rhs) {
            return __array_ops.binary_add(lhs, rhs);
        };
    };
    ...
    struct _div {
        inline __host__ __device__PDEProgram::Float operator()(const PDEProgram::Float& num, const PDEProgram::Float& den) {
            return __array_ops.div(num, den);
        };
        inline __host__ __device__PDEProgram::Array operator()(const PDEProgram::Float& num, const PDEProgram::Array& den) {
            return __array_ops.div(num, den);
        };
    };
    ...
    struct _psi {
        inline __host__ __device__PDEProgram::Float operator()(const PDEProgram::Index& ix, const PDEProgram::Array& array) {
    ...
    struct _rotate {
        inline __host__ __device__PDEProgram::Array operator()(const PDEProgram::Array& a, const PDEProgram::Axis& axis, const PDEProgram::Offset& o) {
    ...
    struct _snippet {
        inline __host__ __device__void operator()(PDEProgram::Array& u, const PDEProgram::Array& v, const PDEProgram::Array& u0, const PDEProgram::Array& u1, const PDEProgram::Array& u2, const PDEProgram::Float& c0, const PDEProgram::Float& c1, const PDEProgram::Float& c2, const PDEProgram::Float& c3, const PDEProgram::Float& c4) {
    ...
    struct _snippet_ix {
        inline __host__ __device__PDEProgram::Float operator()(const PDEProgram::Array& u, const PDEProgram::Array& v, const PDEProgram::Array& u0, const PDEProgram::Array& u1, const PDEProgram::Array& u2, const PDEProgram::Float& c0, const PDEProgram::Float& c1, const PDEProgram::Float& c2, const PDEProgram::Float& c3, const PDEProgram::Float& c4, const PDEProgram::Index& ix) {
...
public:
    ...
    struct _step {
        inline __host__ __device__void operator()(PDEProgram::Array& u0, PDEProgram::Array& u1, PDEProgram::Array& u2, const PDEProgram::Float& nu, const PDEProgram::Float& dx, const PDEProgram::Float& dt) {
